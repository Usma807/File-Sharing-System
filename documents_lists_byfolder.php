...
<head>
    ...
    <title>Hujjatlar ro'yxati </title>
...
<body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="notification" class="alert alert-danger" role="alert">
                                        <b> <i class="bi bi-exclamation-triangle-fill"></i> O'chirilgan ! </b>Hujjat "<b
                                ...
                                ?>
                                    <div id="notification" class="alert alert-success" role="alert">
                                        <b> <i class="bi bi-x-circle-fill"></i> Muvaffaqiyatli ! Hujjat umumiy jildga muvaffaqiyatli ulashildi.
                                    </div>
                                    <?php
                                ...
                                ?>
                                    <div id="notification" class="alert alert-danger" role="alert">
                                        <b> <i class="bi bi-exclamation-triangle-fill"></i> Muvaffaqiyatsiz ! Hujjat allaqachon
                                             ushbu umumiy jildda ulashilgan.
                                    </div>
                                    <?php
                                ...
                                ?>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-body text-wrap">
                                                                            ...
                                                                            <div class="alert alert-danger"
                                                                                ...
                                                                                <br><br>
                                                                                <b class="fs-6 text-center text-danger">Haqiqatan ham oʻchirib tashlamoqchimisiz "<span
                                                            ...
                                                            <div class="modal fade" id="share<?= $row['doc_id'] ?>"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h1 class="modal-title fs-5"
                                                                                id="exampleModalLabel">Hujjatlarni ulashish
                                                                            </h1>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                                aria-label="Close"></button>
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="exampleInputEmail1"
                                                                                        class="form-label">Umumiy jildni tanlash </label>
                                                                                    ...
                                                                                    <select name="sharefolder"
                                                                                        ...
                                                                                        <?php
                                                                                                ...
                                                                                                ?>
                                                                                        <option value="" disabled>Umumiy jild faol emas
                                                                                        </option>
                                                                                        <?php
                                                                                            }
                                                                                            ?>
                                                                                ...
                                                                                <button type="submit"
                                                                                    class="btn btn-primary float-end">Ulashish</button>
                                                                            </form>
                                                                        </div>
                                    ...
                                    <button class="btn btn-inverse-dark btn-rounded btn-sm" onclick="goBack()"><i
                                            class="bi bi-arrow-left-short"></i> Orqaga</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    pdfViewerContainer.style.height = '500px'; 
