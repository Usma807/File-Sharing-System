...
if ($_SESSION['role'] == 0) {
?>
        <li class="nav-item nav-category">Hujjatlar</li>
        <li class="nav-item">
            <a class="nav-link" href="new_document.php">
                <i class="bi bi-cloud-arrow-up fs-5"></i> &nbsp; &nbsp;
                <span class="menu-title">Hujjatlarni yuklash</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="documents_lists.php">
                <i class="bi bi-file-pdf fs-5"></i> &nbsp; &nbsp;
                <span class="menu-title">Hujjatlar ro'yxati</span>
            </a>
        </li>

        <li class="nav-item nav-category">Jildlar</li->
        <li class="nav-item">
            <a class="nav-link" href="new_folder.php">
                <i class="bi bi-folder fs-5"></i> &nbsp; &nbsp;
                <span class="menu-title">Jildlar </span>
            </a>
        </li>
        <li class="nav-item nav-category">Guruh</li->
        <li class="nav-item">
            <a class="nav-link" href="shared_folder.php">
                <i class="bi bi-collection fs-5"></i> &nbsp; &nbsp;
                <span class="menu-title">Umumiy jildlar </span>
            </a>
        </li>
        <li class="nav-item nav-category">Do'stlar</li>
        <li class="nav-item">
            <a class="nav-link" href="new_friend.php">
                <i class="bi bi-person-plus-fill fs-5"></i> &nbsp; &nbsp;
                <span class="menu-title"> Yangi do'st </span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="friends_list.php">
                <i class="bi bi-people-fill fs-5"></i> &nbsp; &nbsp;
                <span class="menu-title"> Do'stlar </span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="user_pin_setup.php">
                ...
                <span class="menu-title">PIN o'rnatish </span>
            </a>
        </li>
        <?php
}else {
